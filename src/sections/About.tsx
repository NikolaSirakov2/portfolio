      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h3 className="text-3xl font-bold text-white mb-6">Hi, I'm Nikol</h3>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="bg-gray-700 p-4 rounded-lg shadow-md">
                ...
                <p className="text-gray-300 text-sm">React, TypeScript, Next.js, Tailwind CSS</p>
              </div>
              <div className="bg-gray-700 p-4 rounded-lg shadow-md">
              ...
              <div className="bg-gray-700 p-4 rounded-lg shadow-md">
                ...
                <p className="text-gray-300 text-sm">React Native, Expo, iOS, Android</p>
              </div>
              <div className="bg-gray-700 p-4 rounded-lg shadow-md">
                <h4 className="font-semibold text-white mb-2">Design & UX</h4>
                <p className="text-gray-300 text-sm">Figma, Adobe Creative Suite, User Research</p>
              </div>
            </div>
